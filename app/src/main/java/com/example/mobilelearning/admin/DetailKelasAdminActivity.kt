...
import com.example.mobilelearning.guru.MateriGuruActivity

class DetailKelasAdminActivity : AppCompatActivity() {
    private lateinit var toolbar: Toolbar
    lateinit var button: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_detail_kelas_admin)
